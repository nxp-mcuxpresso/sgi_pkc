...
MCUXCSSL_MEMORY_EX_FUNCTION(mcuxCsslMemory_Compare_example)
{
    ...
    /* mcuxCsslParamIntegrity_Checksum_t chk,*/ MCUX_CSSL_PI_PROTECT(arr1, arr1, sizeof(arr1)),
    /* void const * lhs,                    */ arr1,
    /* void const * rhs,                    */ arr1,
    ...
    /* mcuxCsslParamIntegrity_Checksum_t chk,*/ MCUX_CSSL_PI_PROTECT(arr1, arr2, sizeof(arr1)),
    /* void const * lhs,                    */ arr1,
    /* void const * rhs,                    */ arr2,
    /* uint32_t length                      */ sizeof(arr1)));
    ...
    /* mcuxCsslParamIntegrity_Checksum_t chk,*/ MCUX_CSSL_PI_PROTECT(arr1, arr3, sizeof(arr1)),
    /* void const * lhs,                    */ arr1,
    /* void const * rhs,                    */ arr3,
    /* uint32_t length                      */ sizeof(arr1)));
