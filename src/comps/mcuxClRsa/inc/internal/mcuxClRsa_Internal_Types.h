...
#define MCUXCLRSA_STATUS_INTERNAL_PRIVEXP_INVALID          ((mcuxClRsa_Status_t) 0xB2B2ADCADu )  ///< The private exponent d does not meet the FIPS 186-4 (B.3.1, step 3) requirements
