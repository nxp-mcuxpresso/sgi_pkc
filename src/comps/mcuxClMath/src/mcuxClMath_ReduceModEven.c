...
MCUX_CSSL_FP_PROTECTED_TYPE(void) mcuxClMath_ReduceModEven(uint32_t iR_iX_iN_iT0, uint32_t iT1_iT2_iT3)
{
    ...
    MCUX_CSSL_ANALYSIS_COVERITY_ASSERT_FP_VOID(pkcByteLenN, MCUXCLPKC_WORDSIZE, MCUXCLPKC_RAM_SIZE - MCUXCLPKC_WORDSIZE)
    ...
    MCUX_CSSL_ANALYSIS_COVERITY_ASSERT_FP_VOID(pkcByteLenX, pkcByteLenN, MCUXCLPKC_RAM_SIZE - MCUXCLPKC_WORDSIZE)
    ...
    MCUX_CSSL_ANALYSIS_COVERITY_ASSERT_FP_VOID(numTrailZeroBits, 1u, (8u * pkcByteLenN) - 1u)
    ...
    MCUX_CSSL_ANALYSIS_COVERITY_ASSERT_FP_VOID(pkcByteLenTZWords, 0u, pkcByteLenN - MCUXCLPKC_WORDSIZE)
    ...
    MCUX_CSSL_ANALYSIS_COVERITY_ASSERT_FP_VOID(pkcByteLenXL, MCUXCLPKC_WORDSIZE, pkcByteLenN)
    ...
    MCUX_CSSL_ANALYSIS_COVERITY_ASSERT_FP_VOID(offsetR_offsetX, ((uint32_t) MCUXCLPKC_RAM_OFFSET_MIN << 16u) + MCUXCLPKC_RAM_OFFSET_MIN,
