...
/**
 * @example mcuxClHashModes_sha3_224_streaming_example.c
...
static const uint32_t hashExpected[] = {0x921e3287u, 0xbee668a8u, 0xaa829123u, 0xf8f65df8u, 0x213b5eecu, 0x31e9c7bcu,0x902af41au};

MCUXCLEXAMPLE_FUNCTION(mcuxClHashModes_sha3_224_streaming_example)
{
    /**************************************************************************/
    /* Preparation                                                            */
    /**************************************************************************/
    ...
    uint32_t context[MCUXCLHASH_CONTEXT_SIZE_SHA3_224_IN_WORDS];
    ...
    uint32_t hash[MCUXCLHASH_OUTPUT_SIZE_SHA3_224 / sizeof(uint32_t)];
    MCUXCLBUFFER_INIT_RW(hashBuf, session, (uint8_t*)hash, sizeof(hash));

    MCUX_CSSL_FP_FUNCTION_CALL_BEGIN(result1, token1, mcuxClHash_init(
    /* mcuxCLSession_Handle_t session: */ session,
    /* mcuxClHash_Context_t context:   */ pContext,
    /* mcuxClHash_Algo_t  algo:        */ mcuxClHash_Algorithm_Sha3_224
    ));
    ...
    /* Verification                                                           */
    /**************************************************************************/
    for(size_t i = 0U; i < (sizeof(hash) / sizeof(uint32_t)); i++)
    {
