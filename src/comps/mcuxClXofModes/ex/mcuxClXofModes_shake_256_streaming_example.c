...
/**
 * @example mcuxClXofModes_shake_256_streaming_example.c
...
MCUXCLEXAMPLE_FUNCTION(mcuxClXofModes_shake_256_streaming_example)
{
    /**************************************************************************/
    /* Preparation                                                            */
    /**************************************************************************/
    ...
    MCUXCLBUFFER_UPDATE(outputBuf, outSize - 10u);
