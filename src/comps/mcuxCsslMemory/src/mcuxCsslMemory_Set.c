...
)
{
    ...
    MCUX_CSSL_DI_RECORD(mcuxCsslMemory_Set_params, pDst);
    ...
    MCUX_CSSL_DI_RECORD(mcuxCsslMemory_Set_params, copyLen);
    ...
    MCUX_CSSL_DI_EXPUNGE(memorySetParam, (uint32_t) p8Dst);
