...
#define MCUX_CSSL_ANALYSIS_START_PATTERN_HW_READ() \
  ...
  MCUX_CSSL_ANALYSIS_START_SUPPRESS_TYPECAST_BETWEEN_INTEGER_AND_POINTER("Read from a HW peripheral")
...
#define MCUX_CSSL_ANALYSIS_START_PATTERN_HW_WRITE() \
  ...
  MCUX_CSSL_ANALYSIS_START_SUPPRESS_TYPECAST_BETWEEN_INTEGER_AND_POINTER("Write to a HW peripheral")
...
#define MCUX_CSSL_ANALYSIS_START_PATTERN_SFR_ACCESS() \
    MCUX_CSSL_ANALYSIS_START_SUPPRESS_INTEGER_OVERFLOW("Offset calculations for HW access cannot overflow.") \
...
#define MCUX_CSSL_ANALYSIS_START_SUPPRESS_SYMBOL_DECLARED_MORE_THAN_ONCE() \
  MCUX_CSSL_ANALYSIS_COVERITY_START_FALSE_POSITIVE(MISRA_C_2012_Rule_8_5, "This symbol declared only once")
#define MCUX_CSSL_ANALYSIS_STOP_SUPPRESS_SYMBOL_DECLARED_MORE_THAN_ONCE() \
  MCUX_CSSL_ANALYSIS_COVERITY_STOP_FALSE_POSITIVE(MISRA_C_2012_Rule_8_5)

#define MCUX_CSSL_ANALYSIS_START_SUPPRESS_OVERFLOWED_TRUNCATED_STATUS_CODE() \
  MCUX_CSSL_ANALYSIS_COVERITY_START_FALSE_POSITIVE(INTEGER_OVERFLOW, "Status code is correctly determined")
#define MCUX_CSSL_ANALYSIS_STOP_SUPPRESS_OVERFLOWED_TRUNCATED_STATUS_CODE() \
...
#define MCUX_CSSL_ANALYSIS_START_PATTERN_DI_CAST() \
  MCUX_CSSL_ANALYSIS_START_SUPPRESS_CAST_OF_COMPOSITE_EXPRESSION("Typecast to Security Counter type for DI record/expunge") \
  MCUX_CSSL_ANALYSIS_START_SUPPRESS_TYPECAST_BETWEEN_INTEGER_AND_POINTER("Typecast pointer to integer for DI record/expunge") \
  MCUX_CSSL_ANALYSIS_START_SUPPRESS_INTEGER_OVERFLOW("DI can wrap")
#define MCUX_CSSL_ANALYSIS_STOP_PATTERN_DI_CAST() \
  MCUX_CSSL_ANALYSIS_STOP_SUPPRESS_INTEGER_OVERFLOW() \
  MCUX_CSSL_ANALYSIS_STOP_SUPPRESS_TYPECAST_BETWEEN_INTEGER_AND_POINTER() \
...
#define MCUX_CSSL_ANALYSIS_START_PATTERN_TWOS_COMPLEMENT_REPRESENTATION() \
  ...
  MCUX_CSSL_ANALYSIS_START_SUPPRESS_OPERATIONS_ON_INAPPROPRIATE_TYPE("Algoritihm works correctly assuming two's complement representation of signed numbers. This is true for target ARM platform.")
...
#define MCUX_CSSL_ANALYSIS_ASSERT_PARAMETER_VOID(value, min_value, max_value) \
  MCUX_CSSL_ANALYSIS_COVERITY_ASSERT(value, min_value, max_value, )
...
#define MCUX_CSSL_ANALYSIS_START_SUPPRESS_CAST_ASSIGNMENT_TO_BOOLEAN(rationale) \
  MCUX_CSSL_ANALYSIS_COVERITY_START_DEVIATE(MISRA_C_2012_Rule_10_5, rationale) \
  MCUX_CSSL_ANALYSIS_COVERITY_START_DEVIATE(MISRA_C_2012_Rule_13_4, rationale)
#define MCUX_CSSL_ANALYSIS_STOP_SUPPRESS_CAST_ASSIGNMENT_TO_BOOLEAN() \
  MCUX_CSSL_ANALYSIS_COVERITY_STOP_DEVIATE(MISRA_C_2012_Rule_13_4) \
  MCUX_CSSL_ANALYSIS_COVERITY_STOP_DEVIATE(MISRA_C_2012_Rule_10_5)

#define MCUX_CSSL_ANALYSIS_START_SUPPRESS_VOLATILE_READ_DUPLICATION(rationale) \
  MCUX_CSSL_ANALYSIS_COVERITY_START_DEVIATE(MISRA_C_2012_Rule_13_2, rationale)
#define MCUX_CSSL_ANALYSIS_STOP_SUPPRESS_VOLATILE_READ_DUPLICATION() \
  MCUX_CSSL_ANALYSIS_COVERITY_STOP_DEVIATE(MISRA_C_2012_Rule_13_2)

#define MCUX_CSSL_ANALYSIS_START_SUPPRESS_RHS_SIDE_EFFECTS(rationale) \
  MCUX_CSSL_ANALYSIS_COVERITY_START_DEVIATE(MISRA_C_2012_Rule_13_5, rationale)
#define MCUX_CSSL_ANALYSIS_STOP_SUPPRESS_RHS_SIDE_EFFECTS() \
...
#define MCUX_CSSL_ANALYSIS_START_SUPPRESS_UNREACHABLE_CODE(rationale) \
  ...
  MCUX_CSSL_ANALYSIS_IAR_START_SUPPRESS_WARNING(Pe111, rationale) \
  MCUX_CSSL_ANALYSIS_ARMCC_START_SUPPRESS_WARNING(111, rationale)
#define MCUX_CSSL_ANALYSIS_STOP_SUPPRESS_UNREACHABLE_CODE() \
  MCUX_CSSL_ANALYSIS_ARMCC_STOP_SUPPRESS_WARNING(111) \
  MCUX_CSSL_ANALYSIS_IAR_STOP_SUPPRESS_WARNING(Pe111) \
...
#define MCUX_CSSL_ANALYSIS_START_SUPPRESS_NESTED_COMMENTS(rationale) \
  MCUX_CSSL_ANALYSIS_COVERITY_START_DEVIATE(MISRA_C_2012_Rule_3_1, rationale)
#define MCUX_CSSL_ANALYSIS_STOP_SUPPRESS_NESTED_COMMENTS() \
...
#define MCUX_CSSL_ANALYSIS_START_PATTERN_URL_IN_COMMENTS() \
  MCUX_CSSL_ANALYSIS_START_SUPPRESS_NESTED_COMMENTS("URLs in comments are allowed for documentation purposes")
#define MCUX_CSSL_ANALYSIS_STOP_PATTERN_URL_IN_COMMENTS() \
...
#define MCUX_CSSL_ANALYSIS_START_SUPPRESS_NOT_ELEMENTS_OF_THE_SAME_OBJECT(rationale) \
  MCUX_CSSL_ANALYSIS_COVERITY_START_DEVIATE(MISRA_C_2012_Rule_18_3, rationale)
#define MCUX_CSSL_ANALYSIS_STOP_SUPPRESS_NOT_ELEMENTS_OF_THE_SAME_OBJECT() \
  MCUX_CSSL_ANALYSIS_COVERITY_STOP_DEVIATE(MISRA_C_2012_Rule_18_3)
...
#define MCUX_CSSL_ANALYSIS_START_SUPPRESS_OBJECT_READ_BEFORE_SET(rationale) \
  MCUX_CSSL_ANALYSIS_COVERITY_START_DEVIATE(MISRA_C_2012_Rule_9_1, rationale)
#define MCUX_CSSL_ANALYSIS_STOP_SUPPRESS_OBJECT_READ_BEFORE_SET() \
  MCUX_CSSL_ANALYSIS_COVERITY_STOP_DEVIATE(MISRA_C_2012_Rule_9_1)
...
#define MCUX_CSSL_ANALYSIS_START_SUPPRESS_AMBIGUOUS_IDENTIFIER(rationale) \
  ...
  MCUX_CSSL_ANALYSIS_COVERITY_START_DEVIATE(MISRA_C_2012_Rule_5_2, rationale) \
...
#define MCUX_CSSL_ANALYSIS_STOP_SUPPRESS_AMBIGUOUS_IDENTIFIER() \
  ...
  MCUX_CSSL_ANALYSIS_COVERITY_STOP_DEVIATE(MISRA_C_2012_Rule_5_2) \
...
#define MCUX_CSSL_ANALYSIS_START_SUPPRESS_DECLARED_BUT_NEVER_REFERENCED(rationale) \
  MCUX_CSSL_ANALYSIS_START_SUPPRESS_UNUSED_VARIABLE(rationale) \
  MCUX_CSSL_ANALYSIS_COVERITY_START_DEVIATE(MISRA_C_2012_Rule_2_2, rationale)
...
#define MCUX_CSSL_ANALYSIS_START_SUPPRESS_ALREADY_INITIALIZED(rationale) \
  MCUX_CSSL_ANALYSIS_COVERITY_START_FALSE_POSITIVE(CERT_EXP33_C, rationale) \
  MCUX_CSSL_ANALYSIS_COVERITY_START_FALSE_POSITIVE(UNINIT, rationale) \
  MCUX_CSSL_ANALYSIS_START_SUPPRESS_OBJECT_READ_BEFORE_SET(rationale)
#define MCUX_CSSL_ANALYSIS_STOP_SUPPRESS_ALREADY_INITIALIZED() \
  MCUX_CSSL_ANALYSIS_STOP_SUPPRESS_OBJECT_READ_BEFORE_SET() \
  MCUX_CSSL_ANALYSIS_COVERITY_STOP_FALSE_POSITIVE(UNINIT) \
  MCUX_CSSL_ANALYSIS_COVERITY_STOP_FALSE_POSITIVE(CERT_EXP33_C)
...
#define MCUX_CSSL_ANALYSIS_START_SUPPRESS_UNUSED_VARIABLE(rationale) \
  MCUX_CSSL_ANALYSIS_GCC_START_SUPPRESS_WARNING(-Wunused-variable, rationale) \
...
#define MCUX_CSSL_ANALYSIS_STOP_SUPPRESS_UNUSED_VARIABLE() \
  ...
  MCUX_CSSL_ANALYSIS_GCC_STOP_SUPPRESS_WARNING(-Wunused-variable)

#define MCUX_CSSL_ANALYSIS_START_SUPPRESS_UNUSED_FUNCTION(rationale) \
  MCUX_CSSL_ANALYSIS_GCC_START_SUPPRESS_WARNING(-Wunused-function, rationale)
#define MCUX_CSSL_ANALYSIS_STOP_SUPPRESS_UNUSED_FUNCTION() \
  MCUX_CSSL_ANALYSIS_GCC_STOP_SUPPRESS_WARNING(-Wunused-function)
...
#define MCUX_CSSL_ANALYSIS_START_SUPPRESS_INVALID_WIDTH_IN_SHIFT_OPERATIONS(rationale) \
  MCUX_CSSL_ANALYSIS_COVERITY_START_DEVIATE(MISRA_C_2012_Rule_12_2, rationale)
#define MCUX_CSSL_ANALYSIS_STOP_SUPPRESS_INVALID_WIDTH_IN_SHIFT_OPERATIONS() \
  MCUX_CSSL_ANALYSIS_COVERITY_STOP_DEVIATE(MISRA_C_2012_Rule_12_2)
...
#define MCUX_CSSL_ANALYSIS_START_SUPPRESS_UNALIGNED_ACCESS() \
  MCUX_CSSL_ANALYSIS_COVERITY_START_DEVIATE(MISRA_C_2012_Rule_11_3, "The CPU supports unaligned memory access.") \
  MCUX_CSSL_ANALYSIS_COVERITY_START_DEVIATE(CERT_EXP36_C, "The CPU supports unaligned memory access.") \
  MCUX_CSSL_ANALYSIS_COVERITY_START_DEVIATE(CERT_EXP39_C, "The CPU supports unaligned memory access.")

#define MCUX_CSSL_ANALYSIS_STOP_SUPPRESS_UNALIGNED_ACCESS() \
  MCUX_CSSL_ANALYSIS_COVERITY_STOP_DEVIATE(CERT_EXP39_C) \
  MCUX_CSSL_ANALYSIS_COVERITY_STOP_DEVIATE(CERT_EXP36_C) \
  MCUX_CSSL_ANALYSIS_COVERITY_STOP_DEVIATE(MISRA_C_2012_Rule_11_3)
...
#define MCUX_CSSL_ANALYSIS_ARMCC_START_SUPPRESS_WARNING(warning_identifier, rationale)  \
  ...
  MCUX_CSSL_ANALYSIS_EXPAND(MCUX_CSSL_ANALYSIS_DEFER(MCUX_CSSL_ANALYSIS_PRAGMA)(diag_suppress warning_identifier))
...
#if defined(MCUX_CSSL_COMPILER_IAR)
#define MCUX_CSSL_ANALYSIS_IAR_START_SUPPRESS_WARNING(warning_identifier, rationale) \
  MCUX_CSSL_ANALYSIS_PRAGMA(diag_suppress=warning_identifier)
#define MCUX_CSSL_ANALYSIS_IAR_STOP_SUPPRESS_WARNING(warning_identifier) \
  MCUX_CSSL_ANALYSIS_PRAGMA(diag_default=warning_identifier)
#else
#define MCUX_CSSL_ANALYSIS_IAR_START_SUPPRESS_WARNING(warning_identifier, rationale)
#define MCUX_CSSL_ANALYSIS_IAR_STOP_SUPPRESS_WARNING(warning_identifier)
#endif
