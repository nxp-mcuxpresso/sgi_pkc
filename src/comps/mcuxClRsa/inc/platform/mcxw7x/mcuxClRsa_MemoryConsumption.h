...
#define MCUXCLRSA_DECRYPT_4096_WAPKC_SIZE     (4280u) ///< Definition of PKC workarea size for the mcuxClRsa_Util_decrypt function for 4096-bit keys.
#ifdef MCUXCL_FEATURE_RSA_8K_KEYS
...
#define MCUXCLRSA_SIGN_PLAIN_4096_WAPKC_SIZE     (4280u) ///< Definition of PKC workarea size for the RSA Sign function for 4096-bit private plain keys.
#ifdef MCUXCL_FEATURE_RSA_8K_KEYS
...
#define MCUXCLRSA_KEYGENERATION_PLAIN_4096_WAPKC_SIZE    (3800u) ///< Definition of PKC workarea size (in bytes) for the mcuxClKey_generate_keypair function required to generate 4096-bit RSA keys in plain form
#ifdef MCUXCL_FEATURE_RSA_8K_KEYS
