...
#define DMA_CH_TOTAL  16u

/**
 *  Defines/Macros for the CH_MUX (Channel Multiplexor) register fields.
 */
#define kDma0RequestDisabled     kDmaRequestDisabled
#define kDma0RequestSGI0Datain  (kDmaRequestSGI0In)
#define kDma0RequestSGI0Dataout (kDmaRequestSGI0Out)
#define DMA_REQ_SRC_DISABLED    (kDmaRequestDisabled)    ///< DMA handshake source for disabling handshakes
#define DMA_REQ_SRC_SGI_IN      (kDmaRequestSGI0In)      // (kDma0RequestSGI0Datain)  ///< DMA handshake source for SGI DATIN
#define DMA_REQ_SRC_SGI_OUT     (kDmaRequestSGI0Out)     // (kDma0RequestSGI0Dataout) ///< DMA handshake source for SGI DATOUT
...
#define SGI_SFR_BASE           SGI_0                                  ///< base of SGI SFRs
...
// #define SGI_HAS_FLUSHWR            1    ///< Not available on W70, because of HYBRID SGI
...
#define TRNG_SFR_BASE           TRNG_0      ///< base of TRNG SFRs
...
#define PKC_RAM_ADDR  ((uint32_t)0x500B0000UL)
#define PKC_WORD_SIZE  8u
#define PKC_RAM_SIZE  ((uint32_t)0x800u)
...
#define GLIKEY0_BASEADDRESS        GLIKEY_BASE  ///< Base address for GLIKEY instance 0
#define GLIKEY1_BASEADDRESS        GLIKEY_BASE  ///< Base address for GLIKEY instance 1

// TODO: Remove this workaround from COSIM targets. This was added due to missing data for Glikey1 on rt700 sample
#define GLIKEY2_BASEADDRESS        GLIKEY_BASE  ///< Base address for GLIKEY instance 1
...
/* FIXME: Fix when header file will contain the proper values */
#define GLIKEY0_IRQn               13               /**< GLIKEY Interrupt  */
