...
#define TRDC_MBC_MEM_GLBCFG_CLRE_MASK            (0xC0000000U)
#define TRDC_MBC_MEM_GLBCFG_CLRE_SHIFT           (30U)
/*! CLRE - Clear Error */
#define TRDC_MBC_MEM_GLBCFG_CLRE(x)              (((uint32_t)(((uint32_t)(x)) << TRDC_MBC_MEM_GLBCFG_CLRE_SHIFT)) & TRDC_MBC_MEM_GLBCFG_CLRE_MASK)
/*! @} */

/* The count of TRDC_MBC_MEM_GLBCFG */
#define TRDC_MBC_MEM_GLBCFG_COUNT                (1U)
...
#define TRDC_MBC_MEMN_GLBAC_COUNT                (1U)
...
#define TRDC_MBC_DOM0_MEM0_BLK_CFG_W_COUNT       (1U)
...
#define TRDC_MBC_DOM0_MEM1_BLK_CFG_W_COUNT       (1U)
...
#define TRDC_MBC_DOM0_MEM2_BLK_CFG_W_COUNT       (1U)
