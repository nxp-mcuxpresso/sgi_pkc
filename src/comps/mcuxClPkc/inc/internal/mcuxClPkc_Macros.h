...
#define MCUXCLPKC_IS_PKC_RAM(address) (((uint32_t)(address) >= (uint32_t)MCUXCLPKC_RAM_START_ADDRESS) && ((uint32_t)(address) < (uint32_t)MCUXCLPKC_RAM_START_ADDRESS + MCUXCLPKC_RAM_SIZE))
