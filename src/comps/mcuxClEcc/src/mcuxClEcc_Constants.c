...
const mcuxClEcc_ScalarMultFunctions_t mcuxClEcc_Weier_ScalarMultFunctions =
{
  ...
  .secVarScalarMultFct = NULL,
  .secVarScalarMultFctFPId = 0u,
  .plainFixScalarMultFct = mcuxClEcc_Weier_PlainFixScalarMult,
  .plainFixScalarMultFctFPId = MCUX_CSSL_FP_FUNCTION_CALLED(mcuxClEcc_Weier_PlainFixScalarMult),
  .plainVarScalarMultFct = NULL,
  .plainVarScalarMultFctFPId = 0u,
};
...
{
  .secFixScalarMultFct = mcuxClEcc_TwEd_SecureFixScalarMult25519,
  .secFixScalarMultFctFPId = MCUX_CSSL_FP_FUNCTION_CALLED(mcuxClEcc_TwEd_SecureFixScalarMult25519),
  .secVarScalarMultFct = mcuxClEcc_TwEd_SecureVarScalarMult,
  .secVarScalarMultFctFPId = MCUX_CSSL_FP_FUNCTION_CALLED(mcuxClEcc_TwEd_SecureVarScalarMult),
...
const mcuxClEcc_EdDSA_DomainParams_t mcuxClEcc_EdDSA_DomainParams_Ed25519 __attribute__((section(".rodata.curve.mcuxClEcc_EdDSA_Ed25519"))) =
{
  ...
  .algoSecHash = mcuxClHash_Algorithm_Sha512,
  .algoHash = mcuxClHash_Algorithm_Sha512,
