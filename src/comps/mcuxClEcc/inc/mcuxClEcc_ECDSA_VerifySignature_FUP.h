...
/** @file  mcuxClEcc_ECDSA_VerifySignature_FUP.h
*  @brief defines FUP programs byte arrays
*/
#ifndef MCUXCLECC_ECDSA_VERIFYSIGNATURE_FUP_H_
#define MCUXCLECC_ECDSA_VERIFYSIGNATURE_FUP_H_
...
#endif /* MCUXCLECC_ECDSA_VERIFYSIGNATURE_FUP*/ 
