...
/**
 * @example mcuxClEcc_ArithmeticOperation_PointSub_NIST_P224_example.c
...
/* First input point for point subtraction */
...
/* Second input point for point subtraciton */
...
#define MAX_CPUWA_SIZE  MCUXCLECC_ARITHMETICOPERATION_POINTSUB_WACPU_SIZE
#define MAX_PKCWA_SIZE  MCUXCLECC_ARITHMETICOPERATION_POINTSUB_WAPKC_SIZE_256 /* minimal workarea size usable for a 224 bit curve */

/**
 * Performs an example point subtraction of two points on NIST_P224
 * @retval MCUXCLEXAMPLE_STATUS_OK    The example code completed successfully
 * @retval MCUXCLEXAMPLE_STATUS_ERROR The example code failed
 */
MCUXCLEXAMPLE_FUNCTION(mcuxClEcc_ArithmeticOperation_PointSub_NIST_P224_example)
{
    /**************************************************************************/
    /* Preparation                                                            */
    /**************************************************************************/
    ...
    /**************************************************************************/
    /* Subtract the two points P1 and P2 on NIST_P224                         */
    /**************************************************************************/
    ...
    MCUX_CSSL_FP_FUNCTION_CALL_BEGIN(pointSub_status, pointSub_token,
        mcuxClEcc_ArithmeticOperation(pSession,
                                     mcuxClEcc_ArithmeticOperation_PointSub,
    ...
    if((MCUX_CSSL_FP_FUNCTION_CALLED(mcuxClEcc_ArithmeticOperation) != pointSub_token) ||
       (MCUXCLECC_STATUS_OK != pointSub_status) || (sizeof(pResult) != resultSize))
    {
