...
typedef struct {
  ...
  __O  uint32_t TCBR[LPUART_TCBR_COUNT];           /**< Transmit Command Burst, array offset: 0x200, array step: 0x4, available only on: AON.LPUART0/AON__LPUART0 (missing on LPUART0, LPUART1) */
  __O  uint32_t TDBR[LPUART_TDBR_COUNT];           /**< Transmit Data Burst, array offset: 0x400, array step: 0x4, available only on: AON.LPUART0/AON__LPUART0 (missing on LPUART0, LPUART1) */
} LPUART_Type;
