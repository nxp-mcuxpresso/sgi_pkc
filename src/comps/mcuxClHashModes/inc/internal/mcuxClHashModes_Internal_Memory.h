...
#define MCUXCLHASH_INTERNAL_WACPU_SIZE_SHA3_DMA_BLOCKING (4u)
...
/* Work area size for SecSha-3 and SecShake */
...
typedef union
{
    ...
    uint8_t mcuxClHash_Internal_WaCpu_Size_SecSha3[MCUXCLHASH_INTERNAL_WACPU_SIZE_SECSHA3];
    uint8_t mcuxClHash_Internal_WaCpu_Size_Sha3_Dma_Blocking[MCUXCLHASH_INTERNAL_WACPU_SIZE_SHA3_DMA_BLOCKING];
...
#define MCUXCLHASHMODES_SHAKE128_CONTEXT_SIZE_INTERNAL \
  (MCUXCLCORE_ALIGN_TO_WORDSIZE(sizeof(uint32_t), \
                               sizeof(mcuxClHash_ContextDescriptor_t) + MCUXCLHASH_CONTEXT_MAX_ALIGNMENT_OFFSET \
                                   + MCUXCLHASH_BLOCK_SIZE_SHA3_SHAKE_128 + MCUXCLHASH_STATE_SIZE_SHA3))
#define MCUXCLHASHMODES_SHAKE256_CONTEXT_SIZE_INTERNAL \
  (MCUXCLCORE_ALIGN_TO_WORDSIZE(sizeof(uint32_t), \
                               sizeof(mcuxClHash_ContextDescriptor_t) + MCUXCLHASH_CONTEXT_MAX_ALIGNMENT_OFFSET \
                                   + MCUXCLHASH_BLOCK_SIZE_SHA3_SHAKE_256 + MCUXCLHASH_STATE_SIZE_SHA3))
#define MCUXCLHASHMODES_SHA256_CONTEXT_SIZE_INTERNAL \
  MCUXCLCORE_ALIGN_TO_CPU_WORDSIZE(sizeof(mcuxClHash_ContextDescriptor_t) + MCUXCLHASH_CONTEXT_MAX_ALIGNMENT_OFFSET \
                                  + MCUXCLHASH_BLOCK_SIZE_SHA_256 + MCUXCLHASH_STATE_SIZE_SHA_256)
