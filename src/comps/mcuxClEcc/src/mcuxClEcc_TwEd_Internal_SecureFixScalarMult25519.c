...
/**
 * @file  mcuxClEcc_TwEd_Internal_SecureFixScalarMult25519.c
 * @brief Secure scalar multiplication with (fixed) base point for twisted Edwards curve Ed25519
 */
...
{
    MCUX_CSSL_FP_FUNCTION_ENTRY(mcuxClEcc_TwEd_SecureFixScalarMult25519);
    (void) pSession;
    ...
    MCUX_CSSL_FP_FUNCTION_CALL(returnScalarMult, mcuxClEcc_TwEd_FixScalarMult(pSession,
            ...
            iScalar,
            scalarBitLength,
            mcuxClEcc_TwEd_PointAddEd25519,
