...
#ifndef MCUXCSSLMEMORY_INTERNAL_SECURECOMPARE_ARM_ASM_H_
#define MCUXCSSLMEMORY_INTERNAL_SECURECOMPARE_ARM_ASM_H_
 ...
 */
MCUX_CSSL_FP_FUNCTION_DECL(mcuxCsslMemory_Int_SecComp_arm_asm)
MCUX_CSSL_FP_PROTECTED_TYPE(mcuxCsslMemory_Status_t) mcuxCsslMemory_Int_SecComp_arm_asm(
    const uint8_t * pLhs,
    const uint8_t * pRhs,
    uint32_t length
);

#endif  /* MCUXCSSLMEMORY_INTERNAL_SECURECOMPARE_ARM_ASM_H_ */
