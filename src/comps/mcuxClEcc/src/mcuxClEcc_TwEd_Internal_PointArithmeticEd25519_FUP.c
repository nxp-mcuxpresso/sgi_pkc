...
const mcuxClPkc_FUPEntry_t mcuxClEcc_FUP_TwEd_PointAddEd25519[20] MCUX_FUP_ATTRIBUTE = {{0x10u,0x00u,0xd1u,0xd3u,0x7du,0x84u},{0x80u,0x00u,0x23u,0x0fu,0x00u,0x19u},{0x80u,0x00u,0x13u,0x19u,0x00u,0x1fu},{0x80u,0x21u,0x10u,0x1fu,0x1fu,0x1fu},{0x80u,0x21u,0x10u,0x0eu,0x0du,0x23u},{0x80u,0x2au,0x10u,0x0eu,0x0du,0x1du},{0x80u,0x21u,0x10u,0x21u,0x20u,0x19u},{0x80u,0x2au,0x10u,0x21u,0x20u,0x21u},{0x80u,0x00u,0x19u,0x23u,0x00u,0x1bu},{0x80u,0x00u,0x21u,0x1du,0x00u,0x19u},{0x80u,0x00u,0x22u,0x3cu,0x00u,0x1du},{0x80u,0x21u,0x10u,0x1du,0x1du,0x22u},{0x80u,0x2au,0x10u,0x1bu,0x19u,0x1du},{0x80u,0x21u,0x10u,0x1bu,0x19u,0x19u},{0x80u,0x2au,0x10u,0x22u,0x1fu,0x1bu},{0x80u,0x21u,0x10u,0x22u,0x1fu,0x1fu},{0x80u,0x00u,0x1du,0x1bu,0x00u,0x20u},{0x80u,0x00u,0x1fu,0x19u,0x00u,0x21u},{0x80u,0x00u,0x1du,0x19u,0x00u,0x23u},{0x80u,0x00u,0x1bu,0x1fu,0x00u,0x22u}};
...
/* FUP program: perform unified extended point addition on Ed25519          */
/* Prerequisites:                                                           */
/* - Buffers TWED_X, TWED_Y, TWED_Z and TWED_T contain the homogeneous      */
/*      coordinates (X1:Y1:Z1:T1) of P1 in MR                               */
/* - Pointers TWED_PP_VX0, TWED_PP_VY0, TWED_PP_VT0 point to the            */
/*      coordinates X2, Y2, T2 in MR                                        */
/* - Buffer TWED_PP_Z contain Z2 in MR                                      */
/* - Depending on currentDigitBitIndex in mcuxClEcc_TwEd_SecureFixScalarMult */
/*   it may be that TWED_PP_VY0 points to ECC_T2 and TWED_PP_VT0 to ECC_T3  */
/* - ps1Len = (operandSize, operandSize)                                    */
/* - Buffer ECC_PFULL contains p'||p                                        */
/* - Buffer ECC_PS contains the shifted modulus associated to p             */
/* Result:                                                                  */
