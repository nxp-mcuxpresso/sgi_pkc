...
/**
 * @example mcuxClCipherModes_Ecb_Aes128_Multipart_PaddingZero_example.c
...
MCUXCLEXAMPLE_FUNCTION(mcuxClCipherModes_Ecb_Aes128_Multipart_PaddingZero_example)
{
  /**************************************************************************/
  /* Preparation                                                            */
  /**************************************************************************/
...
#define MCUXCLCIPHERMODES_CONTEXT_SIZE MCUXCLCIPHER_AES_CONTEXT_SIZE
  ...
  MCUX_CSSL_ANALYSIS_STOP_PATTERN_REINTERPRET_MEMORY_OF_OPAQUE_TYPES()
    ...
    /* mcuxClCipher_Mode_t mode:               */ mcuxClCipher_Mode_AES_ECB_PaddingISO9797_1_Method1,
