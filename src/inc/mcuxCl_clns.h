 ...
 */
#define MCUXCL_VERSION "DCI_SDK_V3.0.0" ///< String literal for the version string of CLNS release that this header is part of
...
/** @attention This header was delivered as part of a CLNS release with the version string: DCI_SDK_V3.0.0.
