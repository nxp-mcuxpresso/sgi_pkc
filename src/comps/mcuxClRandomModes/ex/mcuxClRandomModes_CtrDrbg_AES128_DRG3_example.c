...
/**
 * @example mcuxClRandomModes_CtrDrbg_AES128_DRG3_example.c
...
MCUXCLEXAMPLE_FUNCTION(mcuxClRandomModes_CtrDrbg_AES128_DRG3_example)
{
    /**************************************************************************/
    /* Preparation                                                            */
    /**************************************************************************/
    ...
    MCUX_CSSL_FP_FUNCTION_CALL_BEGIN(rs_status, selftest_token, mcuxClRandom_selftest(
                                        session,
                                        mcuxClRandomModes_Mode_CtrDrbg_AES128_DRG3
                                   ));
    ...
    uint32_t context[MCUXCLRANDOMMODES_CTR_DRBG_AES128_CONTEXT_SIZE_IN_WORDS] = {0};
