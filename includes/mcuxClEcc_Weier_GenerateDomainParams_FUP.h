...
/** @file  mcuxClEcc_Weier_GenerateDomainParams_FUP.h
*  @brief defines FUP programs byte arrays
*/
#ifndef MCUXCLECC_WEIER_GENERATEDOMAINPARAMS_FUP_H_
#define MCUXCLECC_WEIER_GENERATEDOMAINPARAMS_FUP_H_
...
#endif /* MCUXCLECC_WEIER_GENERATEDOMAINPARAMS_FUP*/ 
